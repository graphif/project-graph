        ...
        <>
          ...
          {onRemove && (
            <Button
              ...
              className="bg-background/80 hover:bg-background absolute right-2 top-2 size-6 rounded-full p-0 opacity-0 backdrop-blur-lg transition-opacity group-hover:opacity-100 [&>svg]:size-3"
              onClick={(e) => {
                e.stopPropagation();
                onRemove();
              }}
