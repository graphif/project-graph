...
import type { ButtonHTMLAttributes, ClassAttributes, ComponentType, ErrorInfo, ForwardRefExoticComponent, KeyboardEvent, MouseEvent, PointerEvent, ReactNode, RefAttributes, RefObject, TouchEvent, WheelEvent } from "react";
...
import type { join } from "@tauri-apps/api/path";
...
declare const entity_create: (typeName: string, data: any, location: { x: number; y: number; }) => Promise<ExtensionEntity>;
declare const entity_onClick: (typeName: string, handler: (payload: ClickEventPayload) => void) => Promise<void>;
declare const entity_registerType: (typeName: string, initialData: any, collisionBox: CollisionBox, renderFn: (data: any) => Promise<ImageBitmap>) => Promise<void>;
declare const fetch_base64: (url: string) => Promise<string>;
declare const fetch_binary: (url: string) => Promise<{ buffer: Uint8Array<ArrayBufferLike>; mimeType: string; }>;
declare const fetch_json: (url: string) => Promise<unknown>;
declare const form: (schema: JSONSchema, options: { title: string; confirmText?: string | undefined; cancelText?: string | undefined; }) => Promise<Record<string, unknown>>;
declare const keybinds_register: (id: string, icon: KeyBindIcon | { $lucide: string; }, defaultKey: string, onPress: () => void, onRelease?: (() => void) | undefined, isContinuous?: boolean | undefined) => Promise<void>;
declare const keybinds_unregisterAll: () => Promise<void>;
declare const settings_getGlobal: (key: string) => Promise<any>;
declare const settings_getOwn: (key: string) => Promise<any>;
declare const settings_setGlobal: (key: string, value: unknown) => Promise<any>;
declare const settings_setOwn: (key: string, value: unknown) => Promise<void>;
declare const shell_execute: (program: string, args?: string[] | undefined, stdin?: string | undefined) => Promise<{ code: number | null; stdout: string; stderr: string; }>;
declare const tabs_getAll: () => Promise<Tab[]>;
declare const tabs_getAllProjects: () => Promise<Project[]>;
declare const tabs_getCurrent: () => Promise<Tab | null>;
declare const tabs_getCurrentProject: () => Promise<Project | null>;
declare const themes_register: (id: string, name: string, description: string | undefined, type: "light" | "dark", themeContent: any) => Promise<void>;
declare const toast: (message: string) => Promise<void>;
declare const toast_error: (message: string) => Promise<void>;
declare const toast_success: (message: string) => Promise<void>;
declare const toast_warning: (message: string) => Promise<void>;
...
declare interface Project {
  ...
  */
  ...
  _isSaving: boolean;
  readonly projectOwnership: ProjectOwnershipLifecycle;
  stage: StageObject[];
  tags: string[];
  /**
  * string：UUID
  ...
  */
  ...
  attachProjectOwnership(ownership: ProjectOwnershipLease | SerializedObject<"ProjectOwnershipLease">): void;
  projectOwnerIdentity: string | undefined;
  canonicalProjectPath: string | undefined;
  activateOpenRuntimeHost(): void;
  /**
  ...
  */
  ...
  saveAs(targetUri: URI | SerializedObject<"URI">, options: { includeThumbnail?: boolean | undefined; }): Promise<void>;
  ...
  */
  addAttachment(data: Blob | SerializedObject<"Blob">, id: string): string;
  ...
  */
  ...
  off(event: string | symbol, listener: (...args: any[]) => void): Project;
...
declare interface ProjectOwnershipLease {
  disposePromise?: Promise<void> | undefined;
  disposed: boolean;
  readonly ownershipId: string;
  readonly canonicalPath: string;
  makeConnectable(): Promise<void>;
  dispose(): Promise<void>;
}
/**
* 关于各种曲线和直线的渲染
...
declare interface TextRenderer {
  readonly project: Project;
  prefixWidth(characters: Array<string>, length: number, size: number, fontFamily: undefined | string, fontWeight: undefined | string): number;
  findPrefixAtWidth(characters: Array<string>, targetWidth: number, size: number, fontFamily: undefined | string, fontWeight: undefined | string): number;
  visibleTextRun(text: string, left: number, size: number, textWidth: number, fontFamily: undefined | string, fontWeight: undefined | string): { text: string; left: number; } | undefined;
  drawText(text: string, location: Vector | SerializedObject<"Vector">, size: number, color: Color | SerializedObject<"Color">, fontFamily: undefined | string, fontWeight: undefined | string): void;
  prepareText(text: string): string;
  drawTextFromCenter(text: string, centerLocation: Vector | SerializedObject<"Vector">, size: number, color: Color | SerializedObject<"Color">, fontFamily: undefined | string, fontWeight: undefined | string): void;
  /**
  * 从左上角画文本
  */
...
declare interface MediaNodeRenderer {
  readonly project: Project;
  render(entity: MediaNode | SerializedObject<"MediaNode">): void;
  renderLoadingState(viewLocation: Vector | SerializedObject<"Vector">, viewSize: Vector | SerializedObject<"Vector">, scale: number): void;
  renderNotFoundState(viewLocation: Vector | SerializedObject<"Vector">, viewSize: Vector | SerializedObject<"Vector">, scale: number): void;
  renderUnsupportedState(entity: MediaNode | SerializedObject<"MediaNode">, viewLocation: Vector | SerializedObject<"Vector">, viewSize: Vector | SerializedObject<"Vector">, scale: number): void;
  renderVideoReady(entity: MediaNode | SerializedObject<"MediaNode">, viewLocation: Vector | SerializedObject<"Vector">, viewSize: Vector | SerializedObject<"Vector">, scale: number): void;
  renderAudioReady(entity: MediaNode | SerializedObject<"MediaNode">, viewLocation: Vector | SerializedObject<"Vector">, viewSize: Vector | SerializedObject<"Vector">, scale: number): void;
  renderCoverImage(bitmap: ImageBitmap | SerializedObject<"ImageBitmap">, viewLocation: Vector | SerializedObject<"Vector">, viewSize: Vector | SerializedObject<"Vector">): void;
  renderSelectedState(entity: MediaNode | SerializedObject<"MediaNode">): void;
}
...
declare interface Renderer {
  ...
  */
  ...
  renderTags(viewRectangle: Rectangle | SerializedObject<"Rectangle">): void;
...
declare interface CollaborationService {
  ...
  readonly remoteCursors: Map<string, RemoteCursor>;
  readonly remoteCursorChats: Map<string, RemoteCursorChat>;
  lastCursorSentAt: number;
  lastLocalCursor: RemoteCursor | null;
  cursorChatInput: HTMLInputElement | null;
  cursorChatTimeout: Timeout | null;
  sessionToken: string | null;
  attachmentSync: Promise<void>;
  readonly syncedAttachments: Map<string, Blob>;
  readonly project: Project;
  isActive: boolean;
  currentRoomId: string | null;
  currentInviteCode: string | null;
  currentRole: CollabRole | null;
  currentMembers: CollabMember[];
  currentPresences: CollabPresence[];
  ...
  emitState(): void;
  setStatus(status: "error" | "idle" | "connecting" | "synced" | "disconnected"): void;
  snapshotMap(): StageMapDoc;
  attachmentIdsInStage(doc: StageMapDoc | SerializedObject<"StageMapDoc">): Set<string>;
  syncAttachments(): Promise<void>;
  queueAttachmentSync(): Promise<void>;
  downloadAttachments(attachmentIds: Iterable<string> | SerializedObject<"Iterable">): Promise<void>;
  applyStageMap(doc: StageMapDoc | SerializedObject<"StageMapDoc">, tags: undefined | Array<string>, references: undefined | { sections: Record<string, string[]>; files: string[]; }): void;
  createRoom(): Promise<{ roomId: string; inviteCode: string; }>;
  joinRoom(inviteCode: string): Promise<void>;
  connectWs(token: string, roomId: string): Promise<void>;
  handleServerMessage(msg: { type: "joined"; roomId: string; version: number; stage: StageMapDoc; tags: string[]; references: { sections: Record<string, string[]>; files: string[]; }; members: CollabMember[]; presences: CollabPresence[]; you: CollabPresence; } | { type: "op"; version: number; delta: unknown; from: string; opId: string; } | { type: "reject"; baseVersion: number; serverVersion: number; reason: string; stage?: StageMapDoc | undefined; tags?: string[] | undefined; references?: { sections: Record<string, string[]>; files: string[]; } | undefined; } | { type: "presence"; event: "join" | "leave"; presence: CollabPresence; } | { type: "cursor"; sessionId: string; x: number | null; y: number | null; } | { type: "cursor_chat"; sessionId: string; x: number | null; y: number | null; text: string; } | { type: "member"; event: "join" | "role" | "leave"; member: CollabMember; } | { type: "attachment"; attachmentId: string; contentType: string; } | { type: "error"; message: string; } | { type: "pong"; } | { type: "auth_ok"; user: { id: string; email: string; name: string; }; }): void;
  handleRemoteOp(msg: { type: "op"; version: number; delta: unknown; from: string; opId: string; }): void;
  handleReject(msg: { type: "reject"; baseVersion: number; serverVersion: number; reason: string; stage?: StageMapDoc | undefined; tags?: string[] | undefined; references?: { sections: Record<string, string[]>; files: string[]; } | undefined; }): void;
  onLocalCommit(): Promise<void>;
  readonly handlePointerMove: (event: PointerEvent | SerializedObject<"PointerEvent">) => void;
  readonly handlePointerLeave: () => void;
  selfPresence: CollabPresence | undefined;
  readonly handleCursorChatInput: () => void;
  readonly handleCursorChatKeydown: (event: KeyboardEvent | SerializedObject<"KeyboardEvent">) => void;
  positionCursorChatInput(location: Pick<RemoteCursor, "x" | "y"> | SerializedObject<"Pick">): void;
  sendCursorChat(text: string, location: Pick<RemoteCursor, "x" | "y"> | SerializedObject<"Pick">): void;
  resetCursorChatTimeout(): void;
  closeCursorChat(): void;
  flushIfDirty(): void;
  leave(): void;
  dispose(): void;
}
declare type CollaborationStatus = "idle" | "connecting" | "synced" | "disconnected" | "error";
declare type CollabStateSnapshot = {
    status: CollaborationStatus;
    roomId: string | null;
    inviteCode: string | null;
    version: number;
...
declare type RemoteCursor = {
    sessionId: string;
    x: number;
    y: number;
};
declare type RemoteCursorChat = RemoteCursor & {
    text: string;
};
/** 持久化成员（按账号） */
declare type CollabMember = {
    userId: string;
    role: CollabRole;
    name: string;
    email: string;
...
declare type CollabRole = "owner" | "editor" | "viewer";
declare type ServerToClientMessage = {
    type: "joined";
    roomId: string;
    version: number;
    stage: StageMapDoc;
...
declare interface ControllerNodeEditClass {
  lastMouseDownClientLocation: Vector | null;
  readonly project: Project;
  mousedown(event: PointerEvent | SerializedObject<"PointerEvent">): void;
...
declare interface ControllerPenStrokeDrawingClass {
  ...
  */
  tryAttachStrokeToSection(stroke: PenStroke | SerializedObject<"PenStroke">, startLocation: Vector | SerializedObject<"Vector">, endLocation: Vector | SerializedObject<"Vector">): void;
...
declare interface AIEngine {
  ...
  referencesInitialization: Promise<AIObjectReferenceRegistry> | undefined;
  readonly requestTraceBuffer: AIRequestTraceBuffer;
  getProjectReferences(project: Project | SerializedObject<"Project">): AIObjectReferenceRegistry;
  prepareProjectReferences(project: Project | SerializedObject<"Project">): Promise<AIObjectReferenceRegistry>;
  getRequestTraceBuffer(): AIRequestTraceBuffer;
  createConversation(project: Project | SerializedObject<"Project">, references: AIObjectReferenceRegistry | SerializedObject<"AIObjectReferenceRegistry">, getContextWindowTokenLimit: () => number | undefined): { references: AIObjectReferenceRegistry; transport: DefaultChatTransport<UIMessage<unknown, UIDataTypes, UITools>>; };
  createChatFetch(project: Project | SerializedObject<"Project">, references: AIObjectReferenceRegistry | SerializedObject<"AIObjectReferenceRegistry">): (input: string | URL | Request, init?: (RequestInit & ClientOptions) | undefined) => Promise<Response>;
...
declare type AIObjectReferenceProject = {
...
declare interface AIObjectReferenceRegistry {
  ...
  nextNodeRef: number;
  nextEdgeRef: number;
  readonly project: AIObjectReferenceProject;
...
declare type AIRequestTraceCallKind = "agent" | "memory-summary" | "unknown";
/**
* 舞台场景复杂度检测器
*/
...
declare interface SectionMethods {
  bigTitleCacheFrame: number;
  readonly bigTitleActiveCache: Map<Section, boolean>;
  readonly bigTitleCoveringAncestorCache: Map<Entity, Section | null>;
  prepareBigTitleFrameCache(): void;
  readonly project: Project;
  /**
...
declare interface DeleteManager {
  ...
  deleteMediaNode(entity: MediaNode | SerializedObject<"MediaNode">): void;
...
declare interface SectionPackManager {
  ...
  * 用于折叠/展开后自动重排树形结构。
  */
  autoLayoutConnectedSections(): void;
  switchCollapse(): void;
  /**
  ...
  */
  targetTextNodeToSection(textNode: TextNode | SerializedObject<"TextNode">, ignoreEdges: boolean, addConnectPoints: boolean, skipHistory: boolean): Section;
  /**
  * 拆包操作
  */
...
declare interface HistoryManager {
  ...
  readonly unwatchHistoryManagerMode: () => void;
...
declare interface ImageNode {
  ...
  */
  ...
  disposed: boolean;
  readonly pendingBitmapTasks: Set<Promise<void>>;
  state: "loading" | "success" | "notFound";
  readonly project: Project;
  unknown: boolean;
  onReady?: (() => void) | undefined;
  loadBitmap(bitmapPromise: Promise<ImageBitmap> | SerializedObject<"Promise">, onLoaded: () => void): void;
  dispose(): Promise<void>;
...
declare type MediaKind = "audio" | "video";
declare interface MediaNode {
  isHiddenBySectionCollapse: boolean;
  uuid: string;
  collisionBox: CollisionBox;
  attachmentId: string;
  ...
  _isSelected: boolean;
  isSelected: boolean;
  state: "loading" | "notFound" | "ready" | "unsupported";
  poster: ImageBitmap | undefined;
  duration: number | undefined;
  naturalWidth: number | undefined;
  naturalHeight: number | undefined;
  aspectRatio: number;
  _lastPlaybackTime: number;
  disposed: boolean;
  isDisposed: boolean;
  readonly pendingTasks: Set<Promise<void>>;
  _cachedMediaUrl: string | undefined;
  readonly project: Project;
  unknown: boolean;
  onReady?: (() => void) | undefined;
  loadMedia(): Promise<void>;
  loadVideo(blob: Blob | SerializedObject<"Blob">): Promise<void>;
  loadAudio(blob: Blob | SerializedObject<"Blob">): Promise<void>;
  generatePoster(videoEl: HTMLVideoElement | SerializedObject<"HTMLVideoElement">, maxWidth: number): Promise<void>;
  reload(): Promise<void>;
  getMediaUrl(): string;
  dispose(): Promise<void>;
  rectangle: Rectangle;
  ...
  resizeHandle(delta: Vector | SerializedObject<"Vector">): void;
  getResizeHandleRect(): Rectangle;
  isInProgressBar(worldPoint: Vector | SerializedObject<"Vector">): boolean;
  getProgressRatio(worldPoint: Vector | SerializedObject<"Vector">): number;
  /**
  * 是否忽略自动对齐功能
  * 例如涂鸦就不吸附对齐
  */
...
declare interface Tab {
  ...
  */
  ...
  off(event: string | symbol, listener: (...args: any[]) => void): Tab;
  emit(event: string | symbol, ...args: Array<any>): boolean;
...
declare interface LruCache<K, V> {
  ...
  */
  ...
  "__@iterator@336"(): MapIterator<[K, V]>;
  readonly "__@toStringTag@928": string;
}
/**
* 颜色对象
* 不透明度最大值为1，最小值为0
...
declare interface Line {
  ...
  */
  isPointNearLine(point: Vector | SerializedObject<"Vector">, tolerance: number): boolean;
  isPointIn(point: Vector | SerializedObject<"Vector">): boolean;
  isCollideWithRectangle(rectangle: Rectangle | SerializedObject<"Rectangle">): boolean;
  isCollideWithLine(line: Line | SerializedObject<"Line">): boolean;
...
export type ExtensionHostApi = {
  ...
  keybinds_register(id: string, icon: (KeyBindIcon | SerializedObject<"KeyBindIcon">) | { $lucide: string; }, defaultKey: string, onPress: () => void, onRelease: undefined | (() => void), isContinuous: undefined | false | true): Promise<void>;
